...
class InvestorsControllerTest < ActionController::TestCase
  ...
  test "should create investor" do
    assert_difference('Investor.count') do
      post :create, investor: { Company: @investor.Company, EBITDA: @investor.EBITDA, Equity_Investment: @investor.Equity_Investment, Revenue: @investor.Revenue }
    end
  ...
  test "should update investor" do
    patch :update, id: @investor, investor: { Company: @investor.Company, EBITDA: @investor.EBITDA, Equity_Investment: @investor.Equity_Investment, Revenue: @investor.Revenue }
    assert_redirected_to investor_path(assigns(:investor))
  end
